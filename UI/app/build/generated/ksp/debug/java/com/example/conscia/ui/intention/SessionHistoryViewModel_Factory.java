...
public final class SessionHistoryViewModel_Factory implements Factory<SessionHistoryViewModel> {
  ...
  public SessionHistoryViewModel get() {
    return newInstance(apiServiceProvider.get(), remoteUsageSyncRepositoryProvider.get(), dataStoreProvider.get());
  }
  ...
  public static SessionHistoryViewModel_Factory create(
      ...
      Provider<RemoteUsageSyncRepository> remoteUsageSyncRepositoryProvider,
      Provider<TrackedAppsDataStore> dataStoreProvider) {
    return new SessionHistoryViewModel_Factory(apiServiceProvider, remoteUsageSyncRepositoryProvider, dataStoreProvider);
  }

  public static SessionHistoryViewModel newInstance(ConsciaApiService apiService,
      RemoteUsageSyncRepository remoteUsageSyncRepository, TrackedAppsDataStore dataStore) {
    return new SessionHistoryViewModel(apiService, remoteUsageSyncRepository, dataStore);
  }
}
