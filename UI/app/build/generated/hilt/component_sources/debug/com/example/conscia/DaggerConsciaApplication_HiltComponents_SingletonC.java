...
import com.example.conscia.presentation.intervention.IntentionPromptActivity_MembersInjector;
...
import com.example.conscia.ui.rules.RulesViewModel;
...
public final class DaggerConsciaApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends ConsciaApplication_HiltComponents.ActivityC {
    ...
    @Override
    public void injectIntentionPromptActivity(IntentionPromptActivity intentionPromptActivity) {
      injectIntentionPromptActivity2(intentionPromptActivity);
    }
    ...
    @CanIgnoreReturnValue
    private IntentionPromptActivity injectIntentionPromptActivity2(
        IntentionPromptActivity instance) {
      IntentionPromptActivity_MembersInjector.injectRuleRepository(instance, singletonCImpl.ruleRepositoryProvider.get());
      return instance;
    }
    ...
    private static final class LazyClassKeyProvider {
      ...
      static String com_example_conscia_ui_rules_RulesViewModel = "com.example.conscia.ui.rules.RulesViewModel";
      ...
      @KeepFieldType
      RulesViewModel com_example_conscia_ui_rules_RulesViewModel2;
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new AuthViewModel(singletonCImpl.provideTrackedAppsDataStoreProvider.get(), singletonCImpl.provideConsciaApiServiceProvider.get(), singletonCImpl.ruleRepositoryProvider.get());
          ...
          return (T) new DashboardViewModel(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule), viewModelCImpl.getTodayUsageUseCase(), viewModelCImpl.getWeeklyUsageUseCase(), viewModelCImpl.getRulesUseCase(), singletonCImpl.weeklySummaryManagerProvider.get(), new EvaluateTrackedAppsUsageUseCase(), singletonCImpl.ruleRepositoryProvider.get(), singletonCImpl.provideConsciaApiServiceProvider.get());
          ...
          case 7: // com.example.conscia.ui.rules.RulesViewModel 
          return (T) new RulesViewModel(viewModelCImpl.getRulesUseCase());

          case 8: // com.example.conscia.ui.intention.SessionHistoryViewModel 
          ...
          case 9: // com.example.conscia.ui.onboarding.StarterRulesViewModel 
          ...
          case 10: // com.example.conscia.ui.tracked.TrackedAppDetailViewModel 
          return (T) new TrackedAppDetailViewModel(singletonCImpl.ruleRepositoryProvider.get(), viewModelCImpl.getTodayUsageUseCase());

          case 11: // com.example.conscia.ui.tracked.TrackedAppsViewModel 
  ...
  private static final class SingletonCImpl extends ConsciaApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.appRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<AppRepository>(singletonCImpl, 14));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 14: // com.example.conscia.data.AppRepository 
