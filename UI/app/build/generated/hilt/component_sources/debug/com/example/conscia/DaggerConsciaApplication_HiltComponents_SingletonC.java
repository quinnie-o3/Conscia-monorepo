...
public final class DaggerConsciaApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends ConsciaApplication_HiltComponents.ActivityC {
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      ...
      MainActivity_MembersInjector.injectApiService(instance, singletonCImpl.provideConsciaApiServiceProvider.get());
      MainActivity_MembersInjector.injectRemoteUsageSyncRepository(instance, singletonCImpl.remoteUsageSyncRepositoryProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new ProfileViewModel(singletonCImpl.provideConsciaApiServiceProvider.get(), singletonCImpl.provideTrackedAppsDataStoreProvider.get());
  ...
  private static final class ServiceCImpl extends ConsciaApplication_HiltComponents.ServiceC {
    ...
    private AccessibilityForegroundAppService injectAccessibilityForegroundAppService2(
      ...
      AccessibilityForegroundAppService_MembersInjector.injectRemoteUsageSyncRepository(instance, singletonCImpl.remoteUsageSyncRepositoryProvider.get());
      return instance;
    }
  }
